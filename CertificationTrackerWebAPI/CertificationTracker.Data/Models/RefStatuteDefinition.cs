...
public partial class RefStatuteDefinition
{
    ...
    public virtual ICollection<Offense> OffenseCdRefstatuteDefinitionNavigations { get; set; } = new List<Offense>();

    public virtual ICollection<Offense> OffenseRefstatuteDefinitionNavigations { get; set; } = new List<Offense>();
    ...
    public virtual ICollection<TrafficStopViolation> TrafficStopViolationCdRefstatuteDefinitions { get; set; } = new List<TrafficStopViolation>();

    public virtual ICollection<TrafficStopViolation> TrafficStopViolationRefstatuteDefinitions { get; set; } = new List<TrafficStopViolation>();
